...
__status__      = "test"
__date__        = "06.03.2014"
__description__ = "Establish connection to SAP HANA DB using shipped with SAP HANA python client routine(dpapi) and load GDELT database from daily updates."
